...
import { FiEye, FiEdit2, FiTrash2, FiPlus, FiImage, FiX, FiSearch } from 'react-icons/fi';
...
const Category = () => {
  ...
  return (
    <div className="p-6">
      ...
      {/* Categories Count and Search - Like reference image */}
      ...
      {/* Categories Table - Updated to match reference structure */}
